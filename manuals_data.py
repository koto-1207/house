MANUALS_DATA = [
    {
        ...
        "keywords": ("使用料,月額,料金,費用,お金,家賃,退去,日割り,金額,利用料金," "支払い,計算,賃料"),
    },
    {
        "title": "宿泊",
        ...
        "keywords": (
            "宿泊,泊まる,泊まり,ゲスト,来客,許可,ルール,申請,鍵,紛失,"
            "防犯,節電,節水,無断,立ち入り禁止,受講生,学習,長期滞在,短期滞在"
        ),
    },
    {
        "title": "施錠について",
        ...
        "帰舎時も同様です。",
        "keywords": "施錠,鍵,ロック,閉める,防犯,外出,帰宅,玄関,セキュリティ,貴重品,金庫,盗難,ドア,戸締り",
    },
    {
        "title": "アメニティ",
        "body": "必要最低限の生活用品は準備しておりますが、アメニティ類はありませんので、必要なものは各自で用意してください。",
        "keywords": "アメニティ,生活用品,用意,準備,持参,必要,備品,持ち物",
    },
    {
        ...
        "keywords": (
            "生活用品,歯磨き,入浴,タオル,ドライヤー,スリッパ,ティッシュ,"
            "座布団,足りない,用意するもの,持ち物,リスト,備品"
        ),
    },
    {
        "title": "お金に関すること",
        ...
        "keywords": "お金,費用,食費,生活費,均等,負担,割り勘,支払い,金銭,管理,ルール,トラブル",
    },
    {
        "title": "その他の使用者について",
        "body": "シェアハウスには、平泉町と連携協定を締結し事業を実施する「世界と平泉株式会社」が入居しています。",
        "keywords": "世界と平泉,利用者,居住者,オフィス,事務室,入居者,会社,企業",
    },
    {
        "title": "来客について",
        "body": "インターホンが鳴り、来訪者が訪れた場合は協力して応対してください。\n"
        "「世界と平泉株式会社」への来訪者以外には、平泉町まちづくり推進課に連絡するように伝えてください。",
        "keywords": "来客,来訪者,訪問者,インターホン,お客さん,面会,応対,連絡先,ルール",
    },
    {
        "title": "過ごし方について",
        ...
        "keywords": (
            "交流,節度,過ごし方,バーベキュー,花火,ルール,禁止事項,近所,騒音," "マナー,生活,地域,挨拶"
        ),
    },
    {
        "title": "駐車場について",
        ...
        "keywords": "駐車場,駐車,車,路上駐車,駐禁,スペース,車両,ルール,場所,時間,平日,週末,パーキング",
    },
    {
        "title": "移動手段・車の乗り合い",
        ...
        "keywords": (
            "移動手段,移動,バス,電車,交通,交通手段,乗り合い,車,会場,買い出し,"
            "トラブル,ルール,通勤,通学,公共交通機関"
        ),
    },
    {
        "title": "食堂",
        ...
        "keywords": (
            "食堂,食事,共有スペース,交流,学習,テレビ,座卓,テーブル,イス,"
            "個室利用,大広間,共有部,リビング,キッチン"
        ),
    },
    {
        "title": "個室",
        ...
        "keywords": "個室,部屋,2階,鍵,パーティション,ルームメイト,いびき,食事,汚損,寝室,1人部屋,2人部屋,プライバシー,ルームシェア",
    },
    {
        "title": "寝具",
        "body": "敷布団、掛布団、枕、それぞれのカバーの計8点の寝具類を1人1セット準備していますので、不足の場合は各自で必要に応じて準備してください。\n"
        "また、定期的にカバーの洗濯(洗濯機で可)や布団干しをしてください。",
        "keywords": "寝具,布団,枕,ベッド,カバー,洗濯,布団干し,シーツ,用意",
    },
    {
        "title": "個室の鍵の閉じこみについて",
        ...
        "keywords": (
            "鍵,閉じこみ,なくした,合鍵,紛失,役場,窓口,開けられない,忘れた,"
            "インロック,トラブル,緊急,連絡先,身分証明書,運転免許証,本人確認,"
            "平日,土日,祝日"
        ),
    },
    {
        ...
        "keywords": "炊事,厨房,キッチン,台所,冷蔵庫,電子レンジ,調理器具,食器,食材,ルール,料理,自炊",
    },
    {
        "title": "リネン室",
        ...
        "keywords": "リネン室,洗濯,洗濯機,乾燥,コインランドリー,洗剤,ハンガー,物干し,乾燥機,無料,ルール",
    },
    {
        "title": "浴室",
    ...
    },
    {
        ...
        "【Password】I11264@1",
        "keywords": "Wi-Fi,ネット,インターネット,無線LAN,パスワード,接続,ネット環境,SSID,設定,使い方",
    },
    {
        "title": "喫煙",
        "body": "施設は完全禁煙です。\n"
        ...
        "keywords": "喫煙,タバコ,たばこ,煙草,禁煙,屋外,場所,ルール,マナー,火災,吸い殻,灰皿",
    },
    {
        "title": "清掃、ごみ出し",
        ...
        "keywords": (
            "清掃,掃除,ごみ出し,ゴミ出し,ごみ,ゴミ,分別,清掃用具,当番,ルール,"
            "清潔,共有部,ゴミ箱,ゴミ袋,指定"
        ),
    },
    {
        ...
        "keywords": (
            "ごみ,ゴミ,ごみ出し日,持込日,曜日,分別,スケジュール,燃えるごみ,"
            "燃やすごみ,燃やせないごみ,プラスチック,かん,びん,ペットボトル,"
            "紙,段ボール,祝日,回収日"
        ),
    },
    {
        ...
        "keywords": "ごみ,ゴミ,ごみ出し,搬入,集積所,役場,流れ,やり方,場所,車,駐車,職員,分別",
    },
    {
        "title": "雪かき",
        "body": "雪かきを行った際は、雪を必ず敷地内にまとめておくようにしてください。\n"
        "道路に出したり、隣接する他の所有者の敷地に落とすことのないよう注意してください。",
        "keywords": "雪,雪かき,積雪,道路,敷地,ルール,冬,除雪",
    },
    {
        "title": "荷物の送付",
        ...
        "keywords": "荷物,送付,配送,郵送,宅配,受け取り,送り先,宛先,郵便,発送,事前,到着日,ルール",
    },
    {
        "title": "感染症対策、体調管理",
    ...
    },
    {
        ...
        "keywords": (
            "体調不良,体調,発熱,熱,風邪,病院,医療機関,コロナ,インフルエンザ,"
            "オンライン受講,病気,症状,ルール,連絡先,受診,期間,出席停止"
        ),
    },
    {
        "title": "公共入浴施設",
